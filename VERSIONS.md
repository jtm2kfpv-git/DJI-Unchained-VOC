...
| 0.7.4 | [`versions/v0.7.4/`](versions/v0.7.4/) | Hardware-tested alpha prerelease focused on USB live view and original recording, without the experimental Shorts/MediaProjection path |
