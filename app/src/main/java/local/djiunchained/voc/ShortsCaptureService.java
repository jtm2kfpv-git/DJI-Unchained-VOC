...
public final class ShortsCaptureService extends Service {
    ...
    private static final String ACTION_START = "local.djiunchained.voc.action.START_SHORTS";
    private static final String ACTION_STOP = "local.djiunchained.voc.action.STOP_SHORTS";
    ...
    private void startRecordingForeground() {
        ...
        Notification notification = new Notification.Builder(this, CHANNEL_ID)
                .setSmallIcon(R.drawable.ic_dji_unchained_voc)
