...
public final class MainActivity extends Activity implements
    ...
    private void buildUi() {
        ...
        TextView title = text("DJI UNCHAINED VOC 0.6 - OFFLINE", 16, Color.WHITE);
    ...
    private void requestDiagnosticsExport() {
        Intent intent = new Intent(Intent.ACTION_CREATE_DOCUMENT)
                ...
                .setType("text/plain")
                .putExtra(Intent.EXTRA_TITLE, "dji-unchained-voc-0.6-diagnostics.txt");
    ...
    private String buildDiagnostics() {
        ...
        return "DJI Unchained VOC 0.6 diagnostics\n"
