...
final class AvcSurfaceDecoder implements Closeable {
    interface Listener {
        ...
        void onFrameRendered(long renderedFrames);
    }
    ...
    private volatile String decoderName = "not started";
        ...
        while (generation == codecGeneration.get()) {
            ...
            try {
                ...
                if (index >= 0) {
                    ...
                    long rendered = renderedFrames.incrementAndGet();
                    listener.onFrameRendered(rendered);
