...
The ready-to-install debug APK is `output/apk/N3-Local-View-0.4.0-debug.apk`. The release APK is unsigned by design; sign it with a private key you control after testing.
